...
export const MemoryControls: React.FC = () => {
  const { deepMemoryEnabled, maxMemoryMessages, toggleDeepMemory, setMaxMemoryMessages } = useSettingsStore()
      ...
      <div className="flex items-center gap-4">
        ...
        {deepMemoryEnabled && (
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-400 w-8">{maxMemoryMessages}</span>
          </div>
        )}
      </div>
